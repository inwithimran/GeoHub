...
/**
 * @param {{type:"post"|"resource"|"notice"|"comment", text?:string, actorName?:string, urgent?:boolean, targetUid?:string}} payload
 *   targetUid is required for type "comment" (the post author who should be notified).
 */
